...
public interface ElectronicServiceRequestModelMapper {
  ...
  @Mapping(target = "deliveryMethodCodeId", ignore = true)
  @Mapping(target = "serviceLevelCodeId", ignore = true)
	@Mapping(target = "statusDate", ignore = true)
  @Mapping(target = "appReceivedDate", ignore = true)
  @Mapping(target = "appReviewedDate", ignore = true)
  @Mapping(target = "appPrintedDate", ignore = true)
  @Mapping(target = "appCompletedDate", ignore = true)
