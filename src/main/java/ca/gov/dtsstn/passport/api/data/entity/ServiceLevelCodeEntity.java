 ...
 */
@Entity(name = "ServiceLevelCode")
@SuppressWarnings({ "serial" })
public class ServiceLevelCodeEntity extends AbstractEntity {
	...
	public ServiceLevelCodeEntity() {
		super();
	}

	@Builder.Constructor
	protected ServiceLevelCodeEntity( // NOSONAR (too many parameters)
			@Nullable String id,
